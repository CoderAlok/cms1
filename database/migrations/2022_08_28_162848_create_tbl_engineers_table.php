...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('tbl_engineers', function (Blueprint $table) {
            $table->bigIncrements('engineer_id');
            $table->bigInteger('distributor_id')->comment('Distributor ID');
            $table->string('name', 100)->comment('Engineer name');
            $table->string('sap_code', 100)->comment('Engineer SAP Code');
    ...
    {
        Schema::dropIfExists('tbl_engineers');
    }
};
