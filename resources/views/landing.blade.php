...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('landing_dist/css/style.css') }}">
...
<body class="is-boxed has-animations">
                    ...
                    <div class="brand header-brand">
                        <h1 class="m-0">
                            <div class="row d-flex">
                                <div class="col-md-6">
                                    <a href="#">
                                        <img class="header-logo-image" src="{{ asset('landing_dist/images/logo.svg') }}"
                                            alt="Logo">
                                    </a>
                                </div>
                                <div class="col-md-6">
                    ...
                    <div class="features-inner section-inner has-bottom-divider">
                        <div class="features-wrap">
                            <div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    <div class="feature-icon">
                                        <img src="{{ asset('landing_dist/images/feature-icon-01.svg') }}"
                                            alt="Feature 01">
                                    </div>
                            ...
                            <div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    <div class="feature-icon">
                                        <img src="{{ asset('landing_dist/images/feature-icon-02.svg') }}"
                                            alt="Feature 02">
                                    </div>
                                    <h4 class="feature-title mt-24">Be Productive</h4>
                                    <p class="text-sm mb-0">Fermentum posuere urna nec tincidunt praesent semper feugiat
                            ...
                            <div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    <div class="feature-icon">
                                        <img src="{{ asset('landing_dist/images/feature-icon-03.svg') }}"
                                            alt="Feature 03">
                                    </div>
                                    <h4 class="feature-title mt-24">Be Productive</h4>
                                    <p class="text-sm mb-0">Fermentum posuere urna nec tincidunt praesent semper feugiat
                            ...
                            <div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    <div class="feature-icon">
                                        <img src="{{ asset('landing_dist/images/feature-icon-04.svg') }}"
                                            alt="Feature 04">
                                    </div>
                                    <h4 class="feature-title mt-24">Be Productive</h4>
                                    <p class="text-sm mb-0">Fermentum posuere urna nec tincidunt praesent semper
                                        feugiat
                                        nibh. A arcu cursus vitae congue mauris. Nam at lectus urna duis convallis.
                                        Mauris rhoncus aenean vel elit scelerisque mauris.</p>
                                </div>
                            ...
                            <div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    <div class="feature-icon">
                                        <img src="{{ asset('landing_dist/images/feature-icon-05.svg') }}"
                                            alt="Feature 05">
                                    </div>
                                    <h4 class="feature-title mt-24">Be Productive</h4>
                                    <p class="text-sm mb-0">Fermentum posuere urna nec tincidunt praesent semper
                            ...
                            <div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    <div class="feature-icon">
                                        <img src="{{ asset('landing_dist/images/feature-icon-06.svg') }}"
                                            alt="Feature 06">
                                    </div>
                                    <h4 class="feature-title mt-24">Be Productive</h4>
                                    <p class="text-sm mb-0">Fermentum posuere urna nec tincidunt praesent semper
                            ...
                            <div class="pricing-table">
                                <div class="pricing-table-inner is-revealing">
                                    ...
                                    <div class="pricing-table-cta mb-8">
                                        <a class="button button-primary button-shadow button-block" href="#">Pre
                                            order now</a>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="{{ asset('landing_dist/js/main.min.js') }}"></script>
</body>
